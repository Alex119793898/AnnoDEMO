...
public class GenSQLProvider {
    ...
    public String genQuerySql(Object obj) throws Exception{
    ...
    public String genUpdateSql(Object obj) throws Exception{
    ...
    public String genDeleteSql(Object obj) throws Exception {

        StringBuffer sql = new StringBuffer("delete from ");
        StringBuffer whereSql = new StringBuffer();

        Table tableAnno = obj.getClass().getAnnotation(Table.class);
